#ifndef __MEM_CACHE_REPLACEMENT_POLICIES_LOG_RP_HH__
#define __MEM_CACHE_REPLACEMENT_POLICIES_LOG_RP_HH__
...
struct LogRPParams;     
typedef LogRPParams Params;

class LogRP : public Base
{
  protected:
  ...
  public:
    explicit LogRP(const Params &p);
    ~LogRP() override = default;
...
#endif // __MEM_CACHE_REPLACEMENT_POLICIES_LOG_RP_HH__
